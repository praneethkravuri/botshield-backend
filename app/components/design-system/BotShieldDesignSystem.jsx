  ...
  return (
    <BotShieldToastProvider>
      <style>{`
        ...
        .botshield-analytics-scrollbar::before,
        .botshield-analytics-scrollbar::after {
          color: #8a8a8a;
          font-size: 12px;
          line-height: 1;
        }
        ...
        .botshield-analytics-scrollbar span {
          display: block;
          flex: 1;
          height: 10px;
          border-radius: 999px;
