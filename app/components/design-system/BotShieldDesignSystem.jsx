  ...
  return (
    <BotShieldToastProvider>
      <style>{`
        ...
        .botshield-fraud-drawer--setup .botshield-fraud-drawer-body {
          display: flex;
          flex-direction: column;
          gap: 12px;
        ...
        .botshield-fraud-drawer--setup > .botshield-fraud-setup-drawer-header h2 {
          margin: 0;
          color: var(--overview-ink);
          font-size: 15px;
          font-weight: 650;
        ...
        .botshield-fraud-drawer--setup > .botshield-fraud-setup-drawer-header p {
          max-width: 380px;
          margin: 3px 0 0;
          color: var(--overview-muted);
          font-size: 12px;
        ...
        .botshield-fraud-drawer--setup > .botshield-fraud-setup-drawer-header button {
          display: grid;
          width: 28px;
          height: 28px;
          flex: 0 0 auto;
        ...
        .botshield-fraud-drawer--setup > .botshield-fraud-setup-drawer-header button:hover {
          background: #f1f2f3;
        }
        .botshield-fraud-drawer--setup .botshield-v2-eyebrow {
          display: block;
          margin-bottom: 4px;
          font-size: 10px;
          letter-spacing: 0.075em;
        ...
        .botshield-fraud-setup-status.is-required {
          border-left: 3px solid #d5c48a;
          background: #fffdf8;
        }
        .botshield-fraud-setup-status.is-connected {
          border-left: 3px solid #8ec8a8;
          background: #f8fbf9;
        }
        ...
        .botshield-fraud-setup-status-copy .botshield-v2-eyebrow {
          margin-bottom: 3px;
        }
        .botshield-fraud-setup-status-copy h3 {
          margin: 0;
          color: var(--overview-ink);
          font-size: 13px;
          font-weight: 650;
        ...
        .botshield-fraud-setup-status-copy p {
          margin: 2px 0 0;
          color: var(--overview-muted);
          font-size: 12px;
          line-height: 1.4;
        ...
        .botshield-fraud-setup-checklist {
          margin: 0;
        }
        ...
        .botshield-fraud-setup-checklist-steps {
          position: relative;
          display: flex;
          flex-direction: column;
          margin: 0;
        ...
        .botshield-fraud-setup-checklist-marker--complete {
          background: #e7f7ed;
          color: #1f5d38;
        }
        .botshield-fraud-setup-checklist-marker--required {
          background: #fff4c7;
          color: #6f5300;
        }
        .botshield-fraud-setup-checklist-marker--waiting {
          background: #f6f6f7;
          color: #8c9196;
        }
        .botshield-fraud-setup-step-eyebrow {
          display: block;
          margin-bottom: 2px;
          color: #6f5300;
          font-size: 10px;
        ...
        .botshield-fraud-setup-checklist-item--complete .botshield-fraud-setup-checklist-topline h4 {
          color: #4a4a4a;
        }
        .botshield-fraud-setup-checklist-item--waiting .botshield-fraud-setup-checklist-topline h4 {
          color: #616161;
        }
        .botshield-fraud-setup-checklist-copy p {
          margin: 2px 0 0;
          color: var(--overview-muted);
          font-size: 12px;
          line-height: 1.4;
        }
        .botshield-fraud-setup-checklist-item--complete .botshield-fraud-setup-checklist-copy p {
          color: #8c9196;
        }
        .botshield-fraud-setup-checklist-item--waiting .botshield-fraud-setup-checklist-copy p {
          color: #8c9196;
        }
        .botshield-fraud-setup-pill {
          display: inline-flex;
          flex: 0 0 auto;
          align-items: center;
          min-height: 20px;
        ...
        .botshield-fraud-setup-pill--complete {
          background: #e7f7ed;
          color: #1f5d38;
        }
        .botshield-fraud-setup-pill--required {
          background: #fff4c7;
          color: #6f5300;
        }
        .botshield-fraud-setup-pill--waiting {
          background: #f1f2f3;
          color: #616161;
        }
        .botshield-fraud-setup-note {
          margin: 4px 0 0;
          color: #8c9196;
          font-size: 11px;
          line-height: 1.4;
        }
        .botshield-fraud-setup-drawer-footer {
          display: flex;
          align-items: center;
          justify-content: space-between;
          gap: 12px;
        ...
        @media (max-width: 840px) {
          ...
          .botshield-fraud-toolbar input { width: 100%; }
        ...
        @media (max-width: 620px) {
          .botshield-fraud-orders-content { width: calc(100% - 28px); }
          ...
          .botshield-fraud-drawer--setup { width: 100vw; }
        }
        ...
        .botshield-fraud-drawer--setup { width: min(500px, 100vw); }
        ...
        .botshield-fraud-drawer:not(.botshield-fraud-drawer--setup) > header h2 { margin: 0; color: #202223; font-size: 19px; font-weight: 680; letter-spacing: -.015em; }
        .botshield-fraud-drawer:not(.botshield-fraud-drawer--setup) > header p { margin: 4px 0 0; color: #686868; font-size: 12px; }
        .botshield-fraud-drawer:not(.botshield-fraud-drawer--setup) > header button { display: grid; width: 30px; height: 30px; flex: 0 0 auto; place-items: center; border: 0; border-radius: 8px; background: transparent; color: #4a4a4a; cursor: pointer; font-size: 22px; line-height: 1; }
        .botshield-fraud-drawer:not(.botshield-fraud-drawer--setup) > header button:hover { background: #eee; }
        ...
        .botshield-fraud-drawer--setup .botshield-fraud-drawer-body > section {
          margin-top: 0;
          padding-top: 0;
          border-top: 0;
        }
        ...
        .botshield-settings-hub-nav-item.is-active {
          background: #f1f2f3;
          font-weight: 650;
          box-shadow: inset 2px 0 0 var(--overview-ink);
        }
        ...
        .botshield-settings-billing-page {
          display: grid;
          gap: 28px;
        }
        .botshield-settings-billing-hero {
          display: grid;
          gap: 10px;
          max-width: 720px;
        }
        .botshield-settings-billing-hero h2 {
          margin: 0;
          color: var(--overview-ink);
        ...
        .botshield-settings-billing-hero p {
          margin: 0;
          max-width: 640px;
          color: var(--overview-muted);
          font-size: 15px;
        ...
        .botshield-pricing-grid {
          display: grid;
          gap: 18px;
          align-items: stretch;
        }
        .botshield-pricing-grid.is-count-1 {
          grid-template-columns: minmax(0, 560px);
          justify-content: center;
        }
        .botshield-pricing-grid.is-count-2 {
          grid-template-columns: repeat(2, minmax(0, 1fr));
        }
        .botshield-pricing-grid.is-count-3 {
          grid-template-columns: repeat(3, minmax(0, 1fr));
        }
        .botshield-pricing-card {
          display: grid;
          gap: 22px;
          min-height: 100%;
          padding: 28px;
        ...
        .botshield-pricing-card.is-current {
          border-color: #b8dcc6;
          background: linear-gradient(180deg, #f8fcf9 0%, #ffffff 42%);
          box-shadow:
            0 0 0 1px rgba(41, 132, 90, 0.08),
            0 10px 28px rgba(32, 34, 35, 0.06);
        }
        .botshield-pricing-current-badge {
          display: inline-flex;
          align-items: center;
          gap: 8px;
          align-self: start;
        ...
        .botshield-pricing-card-top {
          display: grid;
          gap: 12px;
        }
        .botshield-pricing-card-top h3 {
          margin: 0;
          color: var(--overview-ink);
          font-size: 18px;
          line-height: 1.2;
        ...
        .botshield-pricing-price {
          display: flex;
          align-items: baseline;
          gap: 4px;
          flex-wrap: wrap;
        }
        .botshield-pricing-price-value {
          color: var(--overview-ink);
        ...
        .botshield-pricing-price-period {
          color: var(--overview-muted);
          font-size: 16px;
          line-height: 1.2;
          font-weight: 650;
        }
        .botshield-pricing-trial {
          margin: 0;
        ...
        .botshield-pricing-card-actions {
          padding-top: 4px;
        }
        .botshield-pricing-divider {
          height: 1px;
          background: #e1e3e5;
        }
        .botshield-pricing-card-bottom {
          display: grid;
          gap: 14px;
        }
        .botshield-pricing-features-label {
          margin: 0;
          color: var(--overview-ink);
          font-size: 13px;
          line-height: 1.2;
        ...
        .botshield-pricing-feature-icon {
          display: inline-flex;
          align-items: center;
          justify-content: center;
          width: 18px;
        ...
        .botshield-pricing-shopify-note {
          display: inline-flex;
          align-items: center;
          gap: 8px;
          margin: 2px 0 0;
        ...
        .botshield-pricing-shopify-note .botshield-v2-icon {
          width: 24px;
          height: 24px;
        }
        .botshield-settings-billing-subscription {
          display: grid;
          gap: 18px;
          padding: 22px 24px;
          border: 1px solid #dfe3e8;
        ...
        .botshield-settings-billing-subscription-head {
          display: grid;
          gap: 6px;
        }
        .botshield-settings-billing-subscription-head h3 {
          margin: 0;
          color: var(--overview-ink);
          font-size: 18px;
          line-height: 1.25;
        ...
        .botshield-settings-billing-subscription-head p {
          margin: 0;
          color: var(--overview-muted);
          font-size: 14px;
          line-height: 1.45;
        }
        .botshield-settings-billing-meta-grid {
          display: grid;
          grid-template-columns: repeat(2, minmax(0, 1fr));
          gap: 14px 18px;
        }
        .botshield-settings-billing-meta-item {
          display: grid;
          gap: 6px;
          min-width: 0;
        }
        .botshield-settings-billing-meta-label {
          color: var(--overview-muted);
          font-size: 12px;
          line-height: 1.2;
          font-weight: 650;
        ...
        .botshield-settings-billing-meta-value {
          color: var(--overview-ink);
          font-size: 14px;
          line-height: 1.35;
          font-weight: 650;
        }
        .botshield-settings-billing-subscription-foot {
          display: flex;
          align-items: center;
          justify-content: space-between;
          gap: 14px;
        ...
        .botshield-settings-billing-subscription-foot p {
          margin: 0;
          color: var(--overview-muted);
          font-size: 13px;
          line-height: 1.4;
        }
        .botshield-settings-billing-dev-note {
          display: grid;
        ...
        .botshield-settings-billing-dev-note-icon .botshield-v2-icon {
          width: 34px;
          height: 34px;
          border-color: #ead6a5;
          background: #fff6e8;
        }
        .botshield-settings-billing-dev-note-copy strong {
          display: block;
          color: var(--overview-ink);
          font-size: 13px;
          line-height: 1.3;
        }
        .botshield-settings-billing-dev-note-copy p {
          margin: 4px 0 0;
          color: var(--overview-muted);
          font-size: 13px;
          line-height: 1.45;
        }
        .botshield-settings-billing-footnote {
          margin: 0;
          color: var(--overview-muted);
          font-size: 13px;
          line-height: 1.5;
        ...
        .botshield-settings-hub-billing-plans-label {
          margin: 0;
          color: var(--overview-muted);
          font-size: 12px;
          font-weight: 650;
        ...
        .botshield-settings-hub-plan-features li {
          position: relative;
          padding-left: 14px;
        }
        .botshield-settings-hub-plan-features li::before {
          content: "·";
          position: absolute;
          left: 0;
          color: var(--overview-ink);
