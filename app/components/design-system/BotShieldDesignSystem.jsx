  ...
  return (
    <BotShieldToastProvider>
      <style>{`
        ...
        .botshield-protection-rate-controls > s-switch { display: block; padding: 11px 12px; }
        ...
        .botshield-protection-signal-list > div { display: grid; gap: 2px; padding: 10px 12px; background: #fff; }
